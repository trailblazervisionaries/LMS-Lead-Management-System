                ...
                {!isLoading && pageLeads.map((lead) => {
                  ...
                  return (
                    <tr key={lead.id} onClick={() => toggleLeadSelection(lead.id)}
                      className={["cursor-pointer transition", isSelected ? "bg-brand-50/60 dark:bg-brand-950/20" : "hover:bg-slate-50/80 dark:hover:bg-slate-900/60"].join(" ")}>
            ...
            <div className="mx-6 mb-5 rounded-xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="text-slate-800 dark:text-slate-100">
                    {pendingSendType === "bulk" ? "All admin leads" : `${selectedWithEmail.length} recipient${selectedWithEmail.length !== 1 ? "s" : ""}`}
                  </span>
                </div>
              </div>
            </div>
