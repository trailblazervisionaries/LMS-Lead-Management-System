    ...
    <section className="space-y-6 pb-10">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-soft dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="grid xl:grid-cols-[220px_1fr]">
          {/* Sidebar stat */}
          <div className="flex flex-col justify-center gap-4 border-b border-slate-100 bg-slate-50/60 px-6 py-6 dark:border-slate-800 dark:bg-slate-950/20 xl:border-b-0 xl:border-r">
            <div>
            ...
            <div>
              <p className="text-xs text-slate-400 dark:text-slate-500">Page</p>
              <p className="mt-0.5 text-sm font-bold text-slate-700 dark:text-slate-300">{currentFollowUpPage}</p>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-sm">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/80 dark:border-slate-800 dark:bg-slate-950/20">
                  ...
                  <th className="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Remark</th>
                  <th className="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Follow-up Date</th>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 px-5 py-3.5 dark:border-slate-800">
              <p className="text-xs text-slate-400 dark:text-slate-500">
                Page <span className="font-semibold text-slate-600 dark:text-slate-300">{currentFollowUpPage}</span>
              </p>
